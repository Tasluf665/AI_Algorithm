...
def depth_first_search(maze_instance):
...
def main():
    ...
    explored_order, solution_path = depth_first_search(maze_instance)
    ...
    textLabel(maze_instance, 'DFS Path Length', len(solution_path) + 1)
    textLabel(maze_instance, 'DFS Search Length', len(explored_order))
